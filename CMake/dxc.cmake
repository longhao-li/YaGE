...
function(YaGEAddGraphicsShaderTarget targetName)
    ...
    while(index LESS ${ARGC})
        ...
        # Update shader type.
        if(currentSource MATCHES "VERTEX|PIXEL|DOMAIN|HULL|GEOMETRY|COMPUTE")
        ...
        elseif(shaderType STREQUAL "COMPUTE")
            set(shaderModel "cs_6_0")
            set(shaderEntry "ComputeMain")
            set(shaderBinarySuffix ".cso")
            set(promptShaderType "compute")
        else()
