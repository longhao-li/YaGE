...
static constexpr const YaGE::KeyCode KEY_CODE_MAP[0x100] = {
    ...
    KeyCode::Insert,       KeyCode::Delete,         KeyCode::Help,       KeyCode::Num0,      KeyCode::Num1,
    ...
    KeyCode::Z,            KeyCode::LeftSuper,      KeyCode::RightSuper, KeyCode::Undefined, KeyCode::Undefined,
    ...
    KeyCode::Numpad9,      KeyCode::Multiply,       KeyCode::Add,        KeyCode::Undefined, KeyCode::Subtract,
    KeyCode::Decimal,      KeyCode::Divide,         KeyCode::F1,         KeyCode::F2,        KeyCode::F3,
