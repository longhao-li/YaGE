...
enum class KeyCode {
    ...
    Numpad8      = VK_NUMPAD8,
    Numpad9      = VK_NUMPAD9,
    Multiply     = VK_MULTIPLY, // Numpad multiply
    Add          = VK_ADD,      // Numpad add
    Subtract     = VK_SUBTRACT, // Numpad subtract
    Decimal      = VK_DECIMAL,  // Numpad decimal
    Divide       = VK_DIVIDE,   // Numpad divide
    F1           = VK_F1,
    F2           = VK_F2,
    F3           = VK_F3,
    F4           = VK_F4,
